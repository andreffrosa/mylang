...
ASTNodeInfo ASTNodeTable[] = {
    ...
    [AST_BITWISE_OR] = {BINARY_OP, false, .type_handler.binary = &binaryExpressionTypeHandler},
    [AST_BITWISE_AND] = {BINARY_OP, false, .type_handler.binary = &binaryExpressionTypeHandler},
    [AST_BITWISE_XOR] = {BINARY_OP, false, .type_handler.binary = &binaryExpressionTypeHandler},
    [AST_BITWISE_NOT] = {UNARY_OP, false, .type_handler.unary = &unaryExpressionTypeHandler},
